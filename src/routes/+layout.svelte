...
<div
	...
	<div class="flex-col rounded-2xl bg-site p-16-40 font-body text-lg">
		<!--  -->
		<header
			class="bg-mainBackground sticky top-0 z-10 mb-88-132 flex items-center justify-between gap-4 pl-3 pt-6 pb-3 md:border-b md:border-solid md:border-primaryColor">
			<a
				href="#maincontent"
