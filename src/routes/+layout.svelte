...
<header
	class="sticky left-0 right-0 top-0 z-20 flex items-center justify-between gap-4 bg-secondaryColor pt-6 pb-3 sm:pt-3 md:border-b md:border-solid md:border-primaryColor md:pt-1">
	<a
		href="#maincontent"
