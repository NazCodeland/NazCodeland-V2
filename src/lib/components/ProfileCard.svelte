...
<article class="flex w-full flex-wrap items-center justify-center gap-16-40">
	...
	<div class="flex flex-col gap-y-4">
		...
		<p class="max-w-[60ch]">
			...
			<a
				href="/portfolio"
				class="forcedClrAdjust relative z-10 inline-block outline-0 delay-[0] before:absolute before:bottom-0 before:h-0.5 before:w-full 
				before:bg-primaryColor before:transition-[h] before:duration-200 before:content-[''] hover:text-[markText] 
				hover:before:-z-10 hover:before:h-full hover:before:bg-primaryColor focus-visible:text-[markText] focus-visible:before:-z-10 focus-visible:before:h-full focus-visible:before:bg-primaryColor contrast-more:before:bg-[activeText] "
				>Portfolio</a
