...
<article class="profile-card">
	<img
		class="imageSize imageBorderW border-solid rounded-full m-auto"
	...
	<div class="profile-card__content">
		...
		<p class="profile-card__copy">
			...
			set, through my <a href="/portfolio" class="link">Portfolio</a>, to potential employers. It's
			also a place for me to <a href="/blog" class="link">Blog</a> about what I am learning and to reference
			it in the future.
		</p>
