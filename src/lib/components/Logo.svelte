...
<h1 class="flex-shrink-0 rounded-sm" aria-labelledby="logo">
	{#each logoTextArray as letter}
		{#if letter === 'N'}
			<a
				href="/"
				class="relative mr-[2px] inline-block cursor-pointer rounded-sm px-[0.05rem] 
		...
		{:else}
			<span
				...
				text-logoNotFirstL leading-logoNotFistL 
